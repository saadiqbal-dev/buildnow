...
export default function Testimony() {
  return (
    <div className="py-24 mx-auto container px-4">
      <div className="flex flex-col-reverse md:grid md:grid-cols-12 gap-3 items-center">
        ...
        <div className="col-span-8 flex flex-col gap-6">
          <p className="text-xl ms-4 md:ms-0 md:text-3xl font-medium before:content-['“'] relative before:absolute before:-left-2 md:before:-left-4 before:text-primary">
