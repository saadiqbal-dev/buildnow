...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex min-w-[360px] items-center justify-center overflow-hidden rounded-lg  bg-muted p-10 "
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-6">
...
const Icons = {
  ...
  twilio: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
      <g transform="matrix(.937042 0 0 .937042 0 .046624)" fill="#e31e26">
